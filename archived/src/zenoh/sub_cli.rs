...
//!
//! Standalone client session via [`run`]. With `discover` enabled, prints new topics
//! and optional stale warnings alongside sample lines.
...
pub fn subscriber_args(edge: &ResolvedEdgeAgent) -> SubscribersArgs {
    SubscribersArgs {
